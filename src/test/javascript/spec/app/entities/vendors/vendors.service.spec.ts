...
describe('Service Tests', () => {
  describe('Vendors Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(VendorsService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Vendors(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Vendors', async () => {
      ...
      it('should update a Vendors', async () => {
        const returnedFromService = Object.assign(
          {
            identifier: 'BBBBBB'
          },
      ...
      it('should delete a Vendors', async () => {
